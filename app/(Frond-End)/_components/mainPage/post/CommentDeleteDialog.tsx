...
import { useDeleteCommentMutation } from "@/feature/slice/post/commentSlice";
        ...
        <div className="text-center flex flex-col items-center justify-center">
          ...
          <div className="mt-4">
            ...
            <p className="text-sm text-descriptionColor leading-[140%] mt-1">
              Are you sure you want to delete the comment? Connection of these
              group no longer be able see the comment in this group!
            </p>
          </div>
