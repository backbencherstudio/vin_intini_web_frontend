...
import { useGetCommentLikeListByPostIdQuery } from "@/feature/slice/post/likeSlice";
...
function CommentLikeList({
  ...
  const { data, isLoading } =
    useGetCommentLikeListByPostIdQuery(groupTimelineArg);
      ...
      <div className="p-4 flex flex-col max-h-[90vh] ">
        <div>
          ...
          <p className="text-grayColor1 text-sm">
            This is a placeholder for the list of users who liked the Comment.
          </p>
        </div>
...
export default CommentLikeList;
