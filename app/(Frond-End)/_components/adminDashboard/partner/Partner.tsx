...
export default function Partner() {
  ...
  const handleDeleteUser = () => {
    if (selectedJob) {
      setJobs((prevJobs) =>
        prevJobs.filter((item) => item.id !== selectedJob.id),
      );
    ...
    <div>
        ...
        <div className="mb-6 flex w-full justify-end">
          <div className="flex w-full flex-col items-start gap-4 lg:w-auto lg:flex-row lg:items-center">
            ...
            <Select value={sort} onValueChange={(value) => setSort(value)}>
              ...
              <SelectContent>
                <SelectItem value="default">Filter by Network</SelectItem>
            ...
            <button
              ...
              className="flex w-full text-nowrap cursor-pointer items-center justify-center gap-2 rounded-md bg-primaryColor px-4 py-2 text-white md:w-auto"
            >
      ...
      <div>
        ...
        <CustomModal
          ...
          size="lg"
        >
          <PartnerForm mode="add" onClose={() => setAddOpen(false)} />
        </CustomModal>
