...
export default function OverViewTable() {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetMySubscribersQuery({ query: queryParams });
      ...
      cell: (row) => (
        <span className="text-ellipsis text-[#0A0A0A] font-['Segoe_UI'] text-sm font-semibold leading-[140%] tracking-[0.07px]">
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-md bg-red-500/80 hover:bg-red-500/90 cursor-pointer px-3 py-1.5 text-white "
          >
            Cancel
          </button>
        </span>
