...
export default function Hero() {
    return (
        ...
        >
            <div className="w-full grid grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-2 xl:grid-cols-[auto_1fr] gap-6 items-center container py-8! sm:py-12! md:py-16! lg:py-24! xl:py-32! 2xl:py-[120px]!">
