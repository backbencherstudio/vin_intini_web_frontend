        ...
        <div className="p-4 sm:p-5 bg-white border border-[#D2D2D5] rounded-2xl space-y-3 hover:shadow-md transition-all duration-300">
            ...
            <div className="flex items-start justify-between gap-2">
                <div className="space-y-1 sm:space-y-2">
                    <h2 className="text-base sm:text-lg font-semibold text-headerColor">{data?.company || "Company Name"}</h2>
            ...
            <div className="flex flex-row items-center justify-between gap-3">
                ...
                <button
                    type="button"
                    className="px-4 py-1 bg-white border border-[#A7EADE] rounded-lg text-buttonColor hover:bg-buttonColor hover:text-[#A7EADE] duration-300 text-sm sm:text-base"
                >
                    View
                </button>
            </div>
