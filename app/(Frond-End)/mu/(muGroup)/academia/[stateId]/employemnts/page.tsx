  ...
  return (
    <div className="">
      <div className="lg:pl-6">
        <AcademiHeader title="Employment Opportunities in Arizona" />
      </div>
        ...
        <div className="w-full flex flex-col lg:flex-row">
          <div className="flex-1 space-y-4 xl:space-y-6 px-0 py-6 lg:py-0 lg:px-6 lg:border-r border-[#A5A5AB]">
            ...
            <div className="space-y-4">
              {data?.data?.state_institution?.items?.map((opportunity: Employment, index: number) => (
          ...
          <div className="flex-1 space-y-4 xl:space-y-6 px-0 py-6 lg:py-0 lg:px-6">
            ...
            <div className="space-y-4">
              {data?.data?.private_practice?.items?.map((opportunity: Employment, index: number) => (
                <EmploymentCard key={opportunity.id} data={opportunity} />
              ))}
            </div>
          </div>
