    ...
    <div className="flex items-center gap-1">
      <div className="flex items-center gap-1 py-1 pl-0 pr-2">
        <button
          ...
          className="flex h-8 items-center justify-center gap-1 rounded border border-[#A5A5AB] px-2 py-1 hover:bg-[#E9E9EA] disabled:opacity-50 disabled:hover:bg-transparent"
        >
